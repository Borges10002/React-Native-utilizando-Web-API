...
import { pegaRepositoriosDoUsuario } from '../../servicos/requisicoes/repositorios';
...
export default function Repositorios({ route, navigation }) {
    ...
    useEffect( async () => {
        const resultado = await pegaRepositoriosDoUsuario(route.params.id);
    ...
    return (
        <View style={estilos.container}>
                ...
                data={repo}
                style={{width: '100%'}}
                keyExtractor={({id}) => console.log(id)}
